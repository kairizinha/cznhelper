...
const characters = [
  ...
  { id: "mei-lin", name: "Mei Lin", job: "striker", faction: "passion", rarity: 4 },
                ...
                >
                  ...
                  <div className="absolute top-2 right-2 flex gap-0.5">
                    {Array.from({ length: character.rarity }).map((_, i) => (
                      <div key={i} className="w-3 h-3 text-orange-400">
                        ★
                      </div>
                    ))}
                  </div>
                  ...
                  <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 via-black/60 to-transparent p-3 pt-8">
                    <h3 className="text-base font-semibold text-white text-center text-balance">{character.name}</h3>
                  </div>
