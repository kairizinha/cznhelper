...
export const weapons: GearData[] = [
  ...
  {
    name: "Brilliant Eternal Flame",
    rarity: "unique",
    slot: "weapon",
    source: ["Burning Life"],
    atk: "90",
    imageName: "brilliant-eternal-flame",
    effect: `Increase Damage Amount of 2-Cost or higher Exhaust cards by 40%`,
  },
  {
    name: "Pale Eternal Flame",
    rarity: "legend",
    slot: "weapon",
    source: ["Burning Life"],
    atk: "82",
    imageName: "pale-eternal-flame",
    effect: `When a card is Exhausted, increase Damage Amount of allies by 20% for 1 turn (1 time per turn)`,
  },
  {
    name: "Veiled Thorn",
    rarity: "legend",
    ...
    source: ["Burning Life"],
    atk: "82",
    imageName: "veiled-thorn",
    effect: `If allies do not receive Damage for 1 turn, then at the start of the next turn, increase Damage Amount by 50% for 1 turn`,
  },
  {
    ...
    source: ["Burning Life"],
    atk: "74",
    imageName: "sword-of-judgment",
    effect: `When a card is Exhausted, increase Damage Amount by 10% for 1 turn (1 time per turn)`,
  },
  {
    name: "Millennium Arbor",
    rarity: "rare",
    slot: "weapon",
    source: ["Burning Life"],
    atk: "74",
    imageName: "millennium-arbor",
    effect: `When a 3-Cost or higher card is activated, 1 Vulnerable to a random enemy`,
  },
...

  {
    ...
    source: ["Other"],
    atk: "82",
    imageName: "harp-of-conflict",
    effect: `Upon enemy Defeat, -2 Stress to the Combatant with the highest Stress
    For 1 turn, when each of Damage, Shield, and Heal has been activated through cards by allies, increase Damage Amount of allies by 15% for 1 turn`,
  },
  {
    name: "Harpoon Case of Broken Resolve",
    rarity: "rare",
    slot: "weapon",
    source: ["Other"],
    atk: "74",
    imageName: "harpoon-case-of-broken-resolve",
    effect: `Create 1 ^card@card_arena_00002^ each odd turn`,
  },
  {
    name: "Arm of Lost Valor",
    rarity: "unique",
    slot: "weapon",
    source: ["Other"],
    atk: "74",
    imageName: "arm-of-lost-valor",
    effect: `When an Attack Card was not activated for 1 turn and the turn is ended, create 1 ^card@card_arena_00001^`,
  },
];
...
export const armors: GearData[] = [
  ...
  // BURNING LIFE
  {
    name: "Vine Lord’s Mask",
    rarity: "legend",
    slot: "armor",
    source: ["Burning Life"],
    def: "31",
    imageName: "vine-lord's-mask",
    effect: `When Drawing an Exhaust card through an ally ability, 80% Fixed Shield (2 times per turn)`,
  },
  {
    ...
    source: ["Burning Life"],
    def: "31",
    imageName: "robe-of-oblivion",
    effect: `When Shield is gained through an Exhaust card, increase Damage Amount by 20% for 1 turn (1 time per turn)`,
  },
  {
    name: "Phytotype Synthetic",
    rarity: "legend",
    slot: "armor",
    source: ["Burning Life"],
    def: "31",
    imageName: "phytotype-synthetic",
    effect: `When Shield is gained, increase Damage Amount of the next 1 Attack Card activated by 20% for 1 turn (2 times per turn)`,
  },
  {
    name: "Shining Lyre",
    rarity: "rare",
    ...
    source: ["Burning Life"],
    def: "28",
    imageName: "shining-lyre",
    effect: `At the start of the turn, if an ally Exhaust card is in hand, 60% Fixed Shield`,
  },
  {
    name: "Moss Armor",
    rarity: "rare",
    ...
    source: ["Burning Life"],
    def: "28",
    imageName: "moss-armor",
    effect: `When an ally Attack Card was not activated for 1 turn and the turn is ended, 100% Fixed Shield`,
  },
  {
    name: "Vine Camouflage",
    rarity: "rare",
    slot: "armor",
    source: ["Burning Life"],
    def: "28",
    imageName: "vine-camouflage",
    effect: `At the start of the turn, if Health is 30% or less, 1 Evade (2 times per battle)`,
  },
...

  {
    ...
    source: ["Other"],
    def: "31",
    imageName: "victor's-laurel",
    effect: `Increase Damage Amount of Counterattack by 40%`,
  },
  {
    name: "Shield of Ashen Sacrifice",
    rarity: "rare",
    slot: "armor",
    source: ["Other"],
    def: "28",
    imageName: "shield-of-ashen-sacrifice",
    effect: `If Damage is completely blocked, at the start of the next turn, create 1 ^card@card_arena_00003^`,
  },
];
...
export const accessories: GearData[] = [
  ...
  // BURNING LIFE
  {
    name: "Liberated Essence",
    rarity: "unique",
    slot: "accessory",
    source: ["Burning Life"],
    health: "91",
    imageName: "liberated-essence",
    effect: `At the start of the turn, decrease Cost of 1 random Exhaust card in hand by 1 for 1 turn`,
  },
  {
    name: "Shining World Tree Stem",
    rarity: "legend",
    slot: "accessory",
    source: ["Burning Life"],
    health: "83",
    imageName: "shining-world-tree-stem",
    effect: `Increase Heal Amount by 25%`,
  },
  {
    name: "Luminescent Shroom",
    rarity: "legend",
    slot: "accessory",
    source: ["Burning Life"],
    health: "83",
    imageName: "luminescent-shroom",
    effect: `Double the effect of Spore Propagation on the 6th Attack Card created for 1 turn`,
  },
  {
    ...
    source: ["Burning Life"],
    health: "83",
    imageName: "leaf-of-the-world-tree",
    effect: `When 3 cards of 2-Cost or higher are used, Stockpile`,
  },
  {
    name: "Lightless Stem",
    rarity: "rare",
    ...
    source: ["Burning Life"],
    health: "75",
    imageName: "lightless-stem",
    effect: `Increase Heal Amount by 15%`,
  },
  {
    name: "Summoned Lump of Light",
    rarity: "rare",
    slot: "accessory",
    source: ["Burning Life"],
    health: "75",
    imageName: "summoned-lump-of-light",
    effect: `Increase Damage Amount of the third Attack Card created by 30% for 1 turn`,
  },
  {
    name: "Golden Bell",
    rarity: "rare",
    ...
    source: ["Burning Life"],
    health: "75",
    imageName: "golden-bell",
    effect: `At the start of battle, decrease Stress of a random ally by 3`,
  },
  {
    name: "Plant Doll",
    rarity: "rare",
    ...
    source: ["Burning Life"],
    health: "75",
    imageName: "plant-doll",
    effect: `When 4 Skill Cards are Exhausted, decrease Stress of a random ally by 1`,
  },
...

  {
    ...
    source: ["Other"],
    health: "83",
    imageName: "rage-potion",
    effect: `When 4 Attack Cards are activated, increase Damage Amount of the next Attack Card activated by 40%`,
  },
  {
    ...
    source: ["Other"],
    health: "83",
    imageName: "gladiators-medallion",
    effect: `When Shield is gained 3 times through cards, 100% Fixed Damage to all enemies`,
  },
  {
    name: "Combat Drum",
    rarity: "legend",
    ...
    source: ["Other"],
    health: "83",
    imageName: "combat-drum",
    effect: `When 5 Skill Cards are created, increase Damage Amount of the next ally card activated by 20% (max 1 stack)`,
  },
  {
    name: "Charger of Weathered Glory",
    rarity: "rare",
    slot: "accessory",
    source: ["Other"],
    health: "75",
    imageName: "charger-of-weathered-glory",
    effect: `If a turn is ended while 1 or more AP remaining, at the start of the next turn, create 1 ^card@card_arena_00005^`,
  },
  {
    name: "Launcher of Ruined Honor",
    rarity: "rare",
    slot: "accessory",
    source: ["Other"],
    health: "75",
    imageName: "launcher-of-ruined-honor",
    effect: `Create 1 ^card@card_arena_00004^ each even turn`,
  },
];
