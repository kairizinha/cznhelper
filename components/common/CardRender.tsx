...
export const CardRender = (props: CardProps) => {
  ...
  console.log('CardRender - card:', card, 'isPlaceholder:', isPlaceholder);

  return <div onClick={()=> onClick?.(card.id)} className={`relative rounded-lg overflow-hidden border-2 border-border hover:border-purple-400/100 transition-all duration-200 max-w-[280px] mx-auto ${scaleOnHover ? 'hover:scale-103' : ''}`}>
    {/* Void Border */}
                ...
                <div className="flex-1 pt-0.5 min-w-0">
                  <div className="relative w-full">
                    ...
                    <div
                      className="absolute"
                      style={{
                        backgroundImage: `url(${getRarityBackgroundImage(card.rarity)})`,
