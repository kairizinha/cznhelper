    ...
    <div className="container mx-auto -mt-16">
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        <section className="bg-[#0a0a0f] border border-blue-500/30 rounded-lg p-6 space-y-4">
          <h2 className="text-white pb-2 border-b border-blue-500/30">
            Project Overview
          </h2>
          <p className="text-gray-400">
            CZN Helper is an open-source fan guide website inspired by the
            Sanity;Gone project for Arknights. Our goal is to provide
            comprehensive, accessible information about characters, cards,
            builds, and game mechanics in Chaos Zero Nightmare.
          </p>
          <p className="text-gray-400 font-bold">
            This project is built and maintained by the community, for the
            community. All content is researched and curated by dedicated
            players who want to help others succeed in the game.
          </p>
        </section>
        ...
        <section className="bg-[#0a0a0f] border border-blue-500/30 rounded-lg p-6 space-y-4">
          ...
          <p className="text-gray-400">Check out the GitHub repository</p>
        </section>
        ...
        <section className="bg-[#0a0a0f] border border-blue-500/30 rounded-lg p-6 space-y-4">
          ...
          <ul className="space-y-2 text-gray-400 ml-6">
            <li className="flex items-start gap-2">
              <span className="text-blue-400 mt-1">•</span>
              <span>
                <strong className="text-white">React:</strong> Component-based
            ...
            <li className="flex items-start gap-2">
              <span className="text-blue-400 mt-1">•</span>
              <span>
                <strong className="text-white">TypeScript:</strong> Type safety
                for reliable data structures
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-blue-400 mt-1">•</span>
            ...
            <li className="flex items-start gap-2">
              <span className="text-blue-400 mt-1">•</span>
              <span>
                <strong className="text-white">Radix UI:</strong> Accessible
        ...
        <section className="bg-[#0a0a0f] border border-blue-500/30 rounded-lg p-6 space-y-4">
          ...
          <p className="text-gray-400 text-sm">
            CZN Helper is an unofficial, fan-made project and is not affiliated
            with, endorsed by, or connected to the developers or publishers of
            Chaos Zero Nightmare. All game content, including character names,
            artwork, and mechanics, are property of their respective owners.
          </p>
          <p className="text-gray-400 text-sm">
            This website is provided for informational and educational purposes
            only. All content is based on community research and personal
            gameplay experience. Information may be incomplete, inaccurate, or
            subject to change as the game updates.
          </p>
        </section>
      </div>
    </div>
