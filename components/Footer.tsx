    ...
    <footer className="border-t border-blue-500/30 bg-[#0a0a0f]/95 mt-auto">
      <div className="container mx-auto px-4 sm:px-6 py-6 sm:py-8">
        <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr_1fr] gap-6 sm:gap-8">
          <div>
            <h3 className="text-white text-base sm:text-lg mb-2 sm:mb-3">
              Disclaimer
            </h3>
            <p className="text-xs sm:text-sm text-gray-400 leading-relaxed">
              CZN Helper is a fan-made guide website for Chaos Zero Nightmare.
              This site is not affiliated with or endorsed by the official game
              developers. All game assets, character names, and related content
              are property of their respective owners. Information provided is
              based on community research and may not be 100% accurate.
            </p>
          </div>
        ...
        <div className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-gray-800 text-center text-xs sm:text-sm text-gray-500">
          <p>
            © 2025 CZN Helper. Community-driven guide project. Not for
            commercial use.
          </p>
        </div>
      </div>
